...
The Exorcist requires **5 Venator shards AND 3 Ancient icons**. The Hungry Chest requires **10 Mimic completions OR 1 rare clue-table reward**. For activity challenges without a drop checklist, organisers still check the written requirements and tick **All requirements for this tile are now met**. Drop checklists do not use that checkbox.
